...
import { addSchema, getByUserApplicationIdSchema } from "./application-documents.dto";
...
export const applicationDocumentsHandler = new Hono().basePath('/application-documents')
    ...
    .get('/:userApplicationId', zValidator('param', getByUserApplicationIdSchema), async (c) => {
